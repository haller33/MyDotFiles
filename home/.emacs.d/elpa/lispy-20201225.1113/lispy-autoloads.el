...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "lispy" '("lh-knight" "lispy-" "mc/cmds-to-run-" "ac-trigger-commands" "unsupported-mode-error" "hydra-lispy-x" "eval-error")))
